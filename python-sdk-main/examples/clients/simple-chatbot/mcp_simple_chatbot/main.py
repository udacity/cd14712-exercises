...
class Configuration:
    ...
    def __init__(self) -> None:
        """Initialize configuration with Vocareum API key."""
...
class LLMClient:
    """Manages communication with the Anthropic Claude LLM via Vocareum."""

    def __init__(self, api_key: str) -> None:
        """Initialize the Anthropic client with Vocareum configuration.

        Args:
            api_key: Vocareum API key for Claude access.
        """
    ...
    def get_response(self, messages: list[dict[str, str]]) -> str:
        """Get a response from Claude via Vocareum.
        ...
        Raises:
            Exception: If the request to Claude fails.
        """
        try:
